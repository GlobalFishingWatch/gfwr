...
scripts with
[`library(gfwr)`](https://github.com/GlobalFishingWatch/gfwr)
...
and adding a variable named `GFW_TOKEN` to the file
...
In case you need to specify the key you can use
...
function allows you to get vessel identity details from the [Vessels
...
#>   index vesselId   ssvid shipname nShipname flag  callsign imo   messagesCounter
#>   <dbl> <chr>      <chr> <chr>    <chr>     <chr> <chr>    <chr>           <int>
#> 1     1 9827ea1ea… 6290… GABU RE… GABUREEF… GMB   C5J278   8300…         1000069
...
> [`gfw_vessel_info()`](https://globalfishingwatch.github.io/gfwr/reference/gfw_vessel_info.md)
> and fetching the vector of responses inside
...
#> 2     1 da1cd7e1b-b8d0-539c-… CARRIER        GFW_VESSEL_LIST                2015
...
#> 8     3 2019-02-10T18:02:49Z 2025-09-01T00:00:00Z 548012100 <chr [1]> 
#> 
#> $combinedSourcesInfo
#> # A tibble: 12 × 10
#>    index vesselId             geartypes_name geartypes_source geartypes_yearFrom
...
#>  7     1 0cb77880e-ee49-2ce4… CARRIER        GFW_VESSEL_LIST                2012
#>  8     1 8c7304226-6c71-edbe… CARRIER        GFW_VESSEL_LIST                2013
#>  9     2 6583c51e3-3626-5638… TUNA_PURSE_SE… COMBINATION_OF_…               2013
#> 10     2 aca119c29-95dd-f5c4… TUNA_PURSE_SE… COMBINATION_OF_…               2012
#> 11     3 55889aefb-bef9-224c… TUNA_PURSE_SE… COMBINATION_OF_…               2017
#> 12     3 71e7da672-2451-17da… TUNA_PURSE_SE… COMBINATION_OF_…               2017
#> # ℹ 5 more variables: geartypes_yearTo <int>, shiptypes_name <chr>,
#> #   shiptypes_source <chr>, shiptypes_yearFrom <int>, shiptypes_yearTo <int>
#> 
#> $selfReportedInfo
...
function allows you to get data on specific vessel activities from the
[Events
API](https://globalfishingwatch.org/our-apis/documentation#events-api).
...
#>  1 2019-12-26 14:10:00 2020-01-03 05:30:00 42a406089abfd… encounter -1.79 -113. 
#>  2 2020-01-01 08:10:00 2020-01-01 10:50:00 9c8905e1c0077… encounter -2.44   50.7
#>  3 2020-01-01 00:00:00 2020-01-01 23:20:00 daf359c6663c8… encounter 44.5   136. 
#>  4 2020-01-01 14:10:00 2020-01-01 23:30:00 5acdf7e969b84… encounter 22.8   117. 
#>  5 2020-01-01 08:30:00 2020-01-02 23:50:00 18937559dfefb… encounter 38.8   121. 
#>  6 2020-01-01 08:10:00 2020-01-01 19:30:00 a8394432b0c78… encounter 35.6   120. 
#>  7 2020-01-01 19:00:00 2020-01-01 21:30:00 e8d849c5554c7… encounter 38.5   121. 
#>  8 2020-01-01 18:20:00 2020-01-01 21:10:00 9219958bd1dec… encounter 38.5   121. 
#>  9 2020-01-01 15:00:00 2020-01-01 18:20:00 fa8f5ac8ae49d… encounter  9.49  -99.1
#> 10 2020-01-01 01:30:00 2020-01-01 08:00:00 70e89e159d487… encounter 35.7   126. 
#> # ℹ 272 more rows
...
#>    start               end                 eventId        eventType    lat   lon
#>    <dttm>              <dttm>              <chr>          <chr>      <dbl> <dbl>
#>  1 2020-10-20 03:23:35 2020-10-20 16:14:26 97790a3a15dc5… fishing    4.89  -51.8
#>  2 2020-10-21 23:23:14 2020-10-22 18:05:07 b4600d56f2387… fishing    4.69  -51.5
#>  3 2020-10-21 05:22:43 2020-10-21 06:12:19 7fe57ee82256c… fishing    0.258 -47.9
#>  4 2020-10-11 10:42:33 2020-10-11 14:06:06 791924103dda5… fishing    0.183 -47.9
#>  5 2020-10-04 09:14:18 2020-10-04 14:41:28 157f544a9b570… fishing   -0.106 -47.7
#>  6 2020-10-20 14:14:15 2020-10-20 19:47:10 aae6ff4415937… fishing    0.252 -47.9
#>  7 2020-10-22 11:17:28 2020-10-22 18:02:00 5c3819505497e… fishing    4.71  -51.5
#>  8 2020-10-01 23:29:31 2020-10-03 03:11:17 4d538f3b37e2a… fishing    4.74  -51.5
#>  9 2020-10-05 08:50:27 2020-10-06 17:35:21 c75671db2488b… fishing    4.71  -51.5
#> 10 2020-10-03 05:50:14 2020-10-05 03:35:27 b68b49e7e3655… fishing    4.73  -51.5
#> # ℹ 49 more rows
#> # ℹ 11 more variables: regions <list>, boundingBox <list>, distances <list>,
#> #   vesselId <chr>, vessel_name <chr>, vessel_ssvid <chr>, vessel_flag <chr>,
#> #   vessel_type <chr>, vessel_publicAuthorizations <list>,
...
When a date range is provided to
[`gfw_event()`](https://globalfishingwatch.github.io/gfwr/reference/gfw_event.md)
using both `start_date` and `end_date`, any event overlapping that range
will be returned, including events that start prior to `start_date` or
end after `end_date`. If just `start_date` or `end_date` are provided,
results will include all events that end after `start_date` or begin
...
This list returns 6569 `vesselIds` belonging to 4203 vessels.
...
#>  3     2 9f555214… 3680… PELICAN  PELICAN   USA   WDJ8253  <NA>           445303
#>  4     2 15cea26f… 3680… PELICAN  PELICAN   USA   <NA>     <NA>              407
#>  5     3 47b94476… 3668… ORION    ORION     USA   <NA>     <NA>            23007
...
#>  9     5 bc29946f… 3667… ALEX     ALEX      USA   WDA2216  <NA>           896473
...
column and send it to the `vessels` parameter in
[`gfw_event()`](https://globalfishingwatch.github.io/gfwr/reference/gfw_event.md)
function.
...
> *Note*:
> [`gfw_event()`](https://globalfishingwatch.github.io/gfwr/reference/gfw_event.md)
> can receive several `vesselIds` at a time but will fail when the
> character length of the whole request is too long (~100,000
> characters). This means it will fail with error **HTTP 422:
...
#>  3     2 9f5552145-50ed-92f4-4514-5177b1a6511d
#>  4     2 15cea26f5-57ad-acac-4cbf-b45cefb7ab04
#>  5     3 47b944765-5819-b2ab-8c2e-cfc82bd2e82c
...
to the function as the `region`, the corresponding region label or iso3
code can be returned. This is especially useful when events are returned
with regions.
