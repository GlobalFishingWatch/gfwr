...
[AIS Vessel Presence Data Caveats](https://globalfishingwatch.org/our-apis/documentation#ais-vessel-presence-caveats), and 
...
```{r, echo = FALSE}
#| fig.alt: >
#|   Above, a map Vessel Presence in the Senegalese EEZ.
#|   Below, the same map but only for vessels present and transiting
#|   at 6-10 knots average speed.
#|   The scale is logarithmic
fl_plot 
sp_plot
```
...
```{r fishing_cargo, fig.width=8, fig.height=6}
vp_all_speeds |>   
